...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "FlowSpring — Water Safety Reports" },
    ],
    links: [
      {
        rel: "stylesheet",
